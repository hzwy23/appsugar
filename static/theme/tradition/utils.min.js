...
var Hutils = {
    ...
    InitDomain:function(param){
        ...
        $.getJSON("/v1/auth/privilege/user/domain",function(data){
            var arr = new Array();
            var domainId = "";
    ...
    HLogOut:function(){
        ...
        $.Hconfirm({
            callback:function(){
                $.ajax({type:"Get",url:"/v1/auth/logout",cache:!1,async:!1,dataType:"text",
